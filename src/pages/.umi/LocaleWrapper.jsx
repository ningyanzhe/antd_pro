...
const localeInfo = {
  'en-US': {
    messages: require('C:/Users/user/Desktop/实训一作业/antd pro/antd_pro/src/locales/en-US.js').default,
    locale: 'en-US',
  ...
  'pt-BR': {
    messages: require('C:/Users/user/Desktop/实训一作业/antd pro/antd_pro/src/locales/pt-BR.js').default,
    locale: 'pt-BR',
  ...
  'zh-CN': {
    messages: require('C:/Users/user/Desktop/实训一作业/antd pro/antd_pro/src/locales/zh-CN.js').default,
    locale: 'zh-CN',
  ...
  'zh-TW': {
    messages: require('C:/Users/user/Desktop/实训一作业/antd pro/antd_pro/src/locales/zh-TW.js').default,
    locale: 'zh-TW',
